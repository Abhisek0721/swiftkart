...
export default function Signup({ toggleSignupModal, setToggleSignupModal }: {
    toggleSignupModal: boolean,
    setToggleSignupModal: Function,
}) {
  return (
    <div className={`w-[95%] sm:w-8/12 lg:w-4/12 fixed inset-0 mx-auto flex flex-col justify-center ${(toggleSignupModal)?(''):('hidden')}`}>
      <Dialog open={toggleSignupModal} onOpenChange={() => setToggleSignupModal(!toggleSignupModal)} >
        ...
        <DialogContent className="bg-white p-10 z-10 rounded-md relative px-5">
          ...
          <DialogHeader className="">
            ...
            <DialogTitle className="font-semibold text-base text-center">Signup for SwiftKart</DialogTitle>
          ...
          <div className="mt-8 flex flex-col items-center">
            <input type="text" placeholder="Name" className="text-sm px-3 py-2 outline-none rounded-sm border-[1px] border-color w-72 mb-2" required />
          ...
          <DialogFooter className="mt-5 flex flex-col items-center">
            <div className="sm:mx-auto w-72">
              ...
              <div>
                ...
                >
                  Signup with <SiGoogle className="ml-2" />oogle
                </Button>
              </div>
            </div>
          </DialogFooter>
